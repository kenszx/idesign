...
description: >
  Fallback mode when user has no clear design direction. Runs 3 parallel
  sub-agents with different strategies (situation roulette, real-world reference,
  best designer philosophy) to produce real HTML visual options for user to choose from.
version: 1.0.0
platforms: [macos, linux, windows]
tags: [design, direction, exploration, style]
