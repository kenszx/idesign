...
description: >
  Extract and apply brand assets (logos, colors, typography) from official
  sources. 5-step hard protocol with fallbacks. Ensures every branded design
  uses authentic assets, not approximations.
version: 1.0.0
platforms: [macos, linux, windows]
tags: [brand, assets, logo, design-system]
